...
export function exercicio1() {
    ...
    for(let numero: number = 0; numero < 11; numero ++ ) {
...
export function exercicio2(){
    ...
    for(let par: number = 0; par < 11; par +=2){
...
export function exercicio3(){
    ...
    for(let sequencia:number = 1; sequencia <=50; sequencia +=2){
...
export function exercicio4(){
    ...
    let numero:number = parseInt(prompt("Digite a tabuada desejada: "));

    for(let tabuada:number = 1; tabuada <= 10; tabuada ++){
...
export function exercicio8(){
    ...
    let idade:string|number = parseInt(prompt("Digite a sua idade: "));
...
export function exercicio9(){
    ...
    let numero:string|number = parseInt(prompt("Digite qualquer número: "));
...
export function exercicio10(){
    ...
    let numero: string|number = parseInt(prompt("Digite um número: "))
